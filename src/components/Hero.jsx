...
import profilePic from "/Users/aryanshjain/Desktop/tail/my-project/src/assets/kevinRushProfile.png"
                ...
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    animate = "visible" 
                     className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">
                        Aryansh Jain</motion.h1>
                        <motion.span variants={conainer(0.5)}
                    initial ="hidden"
